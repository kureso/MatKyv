...
\begin{abstract}
V tejto správe sa budeme zaoberať pohybom matematického kyvadla popísaným ako aj lineárnymi, tak aj nelineárnymi diferenciálnymi rovnicami. Pomocou eliptického integrálu a perturbačnej metódy získame aproximácie preiódy kmitov a porovnáme ich s numerickým riešením v programe Mathematica.
\end{abstract}
